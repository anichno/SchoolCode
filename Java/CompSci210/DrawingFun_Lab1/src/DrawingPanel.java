...
public class DrawingPanel extends Thread implements MouseInputListener, KeyListener
{
    ...
    public void mousePressed(MouseEvent e)
    {
      ...
      buttonDownWhen[mostRecentMouseButton] = e.getWhen();
    }
    ...
    public void mouseReleased(MouseEvent e)
    {
      ...
      long timeBetweenPressAndRelease  // in milliseconds
              = e.getWhen() - buttonDownWhen[mostRecentMouseButton];
      
      if (timeBetweenPressAndRelease < 1000) // less than one second
      {
        // consider this a mouse click
        //System.out.printf("mouseClicked called - waitingForButton = %d\n",
        //                   waitingForButton);
        ...
        if ( waitingForButton == mostRecentMouseButton )
        {
    ...
    {
      // 15 Nov 2008
      // Java seems to be missing mouse clicks in random behavior.
      // To make mouse clicks more reliable, the mouseReleased method is used
      // to recognize mouse clicks.
//       System.out.printf("%3d mouseClicked called - waitingForButton = %d\n",
//                         c++, waitingForButton);
